...
# Antialiased nodes can be created by right-clicking anywhere
...
config = netgraph.NetConfig(
    node_config=netgraph.NodeConfig(
        antialiased=True
    )
)
...
net_manager = netgraph.NetManager(canvas, config=config)
